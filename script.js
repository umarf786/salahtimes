...
function pos() {
  ...
  $(document).ready(function(){
    $.getJSON('https://api.aladhan.com/v1/timings/'+timestamp+'?latitude='+data.coords.latitude+'&longitude='+data.coords.longitude+'&method=3&school=1&tune=0,35,0,60,95,110,0,75,0', function(data1){
